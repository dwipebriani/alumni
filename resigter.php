...
$sql ="INSERT INTO users (name, username, email, passsword) VALUES (:name, :username, :email, :password)";
$stmt = $db->prepare($sql);
              ...
              <div class="col-lg-6 mx-auto mt-5">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Silahkan Regsitrasi </h1>
                  </div>
                  <form class="user" method="post">
                    ...
                    <input type="submit" name="kirim" class="btn btn-primary btn-user btn-block">

<?php 
session_start();
if(!isset($_SESSION['user_username'])) header("location:login_user.php");
include "../../config.php";
        ...
        <div class="card-body">
          <div class="table-responsive">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Komentar Tentang</label>
                <input class="form-control"  name="hal" required="">
              </div>   
               ...
               <div class="form-group">
                ...
                <input class="form-control" type="hidden" name="status" value="proses" required="">
              </div>  
                <div class="form-group">
                <label>Foto</label>
                <input type="file" name="foto" required="">
                    ...
                    <div class="form-group">
                        ...
                        <a href="../alumni_user.php" class="btn btn-info">Kembali</a>
                    </div>
            </form>
            </div></div>
        </div>
...
$tambah = mysqli_query($koneksi, "INSERT INTO tbl_komen VALUES('','$nama','$hal','$isi','$status','$file_name')");
 ...
 // cek apakah data berhasil ditambahkan atau tidak
  if($tambah) {
    ...
    <script>
      ...
      window.location.href = '../alumni_user.php';
    </script> 

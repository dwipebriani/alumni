    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <span><?php echo  $_SESSION['user_nama_user'] ;?></span></a> 
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php   
                  ...
                  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_data_alumni"); ?>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                   ...
                   <div class="text-left">
                  <a href="proses-tambah/tambahalumni_user.php" class="btn btn-primary">[+]Tambah Alumni</a>
                </div><br>

...
<head>
    ...
    <!-- <link rel="stylesheet" type="text/css" href="http://localhost/website/Backend/lib_lowongan/bootstrap.css"> -->
...
<nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
      <a style="color: white" class="navbar-brand" href="../lowongan.php"> <b>Kembali</b></a>    
    </nav>
  <div class="container">
  <!-- ini pengumuman -->
  ...
  <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-sm-9">
           ...
           <input type="hidden" name="id_lowongan" value="<?= $lowongann["id_lowongan"]; ?>">
